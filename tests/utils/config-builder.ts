...
export class TestConfigBuilder {
   ...
   * Set capabilities
   */
  withCapabilities(capabilities: Partial<ExtendedProviderConfig['capabilities']>): TestConfigBuilder {
   ...
   */
  private getProviderDefaults(type: ExtendedProviderConfig['type']): Partial<ExtendedProviderConfig> {
    switch (type) {
      case 'ollama':
        return {
