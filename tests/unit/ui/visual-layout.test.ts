...
describe('Visual Layout Utilities', () => {
  ...
  describe('processLogicalLine', () => {
    ...
    it('should process line that needs wrapping', () => {
      const logLine = 'This is a very long line that definitely needs to be wrapped';
      const logIndex = 0;
  ...
  describe('memoizedCalculateVisualLayout', () => {
    it('should handle empty text', () => {
      ...
      const result = memoizedCalculateVisualLayout(logicalLines, logicalCursor, viewportWidth);
  ...
  describe('cache behavior', () => {
    ...
    it('should handle cache size limits gracefully', () => {
      ...
      const finalResult = memoizedCalculateVisualLayout(['Final test'], [0, 0], 80);
