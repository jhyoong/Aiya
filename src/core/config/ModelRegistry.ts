...
export class ModelRegistry {
   ...
   */
  static getModelMetadata(providerType: keyof ProviderModels, modelName: string): ModelMetadata | undefined {
   ...
   */
  static validateModelExists(providerType: keyof ProviderModels, modelName: string): boolean {
   ...
   */
  static getModelsSortedByCost(providerType: keyof ProviderModels): ModelMetadata[] {
    const registry = PROVIDER_REGISTRY[providerType];
    if (!registry) {
      return [];
    }
  ...
  private static getCapabilitiesDescription(providerType: keyof ProviderModels): string {
    const capabilities = {
